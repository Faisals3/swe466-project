...
export default function ViewTasksWithResourcesWithCost() {
        ...
        let tempArray = [];
            tasks?.forEach(element => {
                let data = [element.TaskID,
                            ...
                            getCost(element.ResourceType,element.ResourceCostHour,element.ResourceCostUse , getDuration(element.StartD,element.StartM,element.StartY,element.FinishD,element.FinishM,element.FinishY)) +'$'
                            ]
